...
First, setup the tc rules in rc.local using commands to assign different DHCP markings to different classids. You can see one such example in [github issue #4563](https://github.com/netdata/netdata/issues/4563#issuecomment-455711973). 
